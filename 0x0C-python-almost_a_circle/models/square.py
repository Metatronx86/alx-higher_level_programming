...
class Rectangle(Base):
    ...
    def validate_integer(self, name, value, eq=True):
        '''Validates if the given value is an integer and satisfies specific criteria.'''
        if type(value) != int:
    ...
    def __update(self, id=None, width=None, height=None, x=None, y=None):
        '''Internal method for updating instance attributes using positional or keyword arguments.'''
        if id is not None:
            self.id = id
    ...
    def update(self, *args, **kwargs):
        '''Updates instance attributes using positional and keyword arguments.'''
        if args:
            self.__update(*args)
        elif kwargs:
